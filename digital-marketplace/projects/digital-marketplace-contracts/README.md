...
By default the template creates a single `HelloWorld` contract under digital_marketplace folder in the `smart_contracts` directory. To add a new contract:
